...
If you want to include an environmental fit, this is where you create a dataframe to do that.
```{r}
...
Plot the NMDS with the environmental fit
```{r}
plot_env <- NMDS_plot +
